    ...
    <section className="max-w-6xl mx-auto px-4 py-12">
      ...
      {projetos.length === 0 ? (
        <div className="text-center py-12">
          <p className="text-gray-600 dark:text-gray-300 mb-4">Nenhum projeto encontrado.</p>
          <p className="text-sm text-gray-500 dark:text-gray-400">Os projetos serão exibidos aqui quando disponíveis na API.</p>
        </div>
      ) : (
